...
describe('ChatScreen Integration Tests', () => {
  ...
  it('should render chat screen with initial message', () => {
    ...
    expect(getByText('Hi! I can help you understand this problem better. What would you like to know?')).toBeTruthy();
  });
  ...
  it('should send message and receive response', async () => {
    ...
    expect(AnalyticsService.track).toHaveBeenCalledWith('chat_response_received', {
      confidence: 0.9,
    });
  });
  ...
  it('should show typing indicator while loading', async () => {
    (GeminiService.chat as jest.Mock).mockImplementation(
      () => new Promise(resolve => setTimeout(() => resolve({ text: 'Response', confidence: 0.9 }), 100))
    );
